...
gulp.task('watch', function () {
    gulp.watch('dev/css/*{.css,.scss}', ['sass']);
...
gulp.task('default', ['iconfont', 'asset_font', 'sass', 'asset_html', 'js', 'asset_img', 'brow_sync', 'watch']);

gulp.task('bild', ['del', 'tinypng', 'iconfont', 'asset_font', 'sass', 'asset_html', 'js']);
